...
%     fre_syntony_test];
fre_matrix = [fre_syntony_calculate, fre_syntony_cst_8, fre_syntony_test];
...
figure_matrix = [bandwidth_cst_8, bandwidth_test, amplitude_syntony_cst_8, ...
    amplitude_syntony_test];
