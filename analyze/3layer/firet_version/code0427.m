...
% E_result3 = merit.process.fd2td(E_output_3d, freq, t);
...
% [E_output2, t_output2] = Transmission3layer(SIG, 30, 50, 1000, 60000);
% E_result1 = merit.process.fd2td(E_output1, freq, t);
% E_result2 = merit.process.fd2td(E_output2, freq, t);
% figure(3)
...
% E_2 = math_att(SIG, 2e9, 100, 30);
% E_result1 = merit.process.fd2td(E_1, freq, t);
% E_result2 = merit.process.fd2td(E_2, freq, t);
% figure(3)
% plot(t, envelope(E_result1), 'g')
% hold on
% plot(t, envelope(E_result2), 'b')
...
%% method -3 layer model
%% valudation (results, imp)model-based testing
